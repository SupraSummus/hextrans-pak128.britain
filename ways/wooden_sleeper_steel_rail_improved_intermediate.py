"""Bake the improved steel rail on wooden sleepers, intermediate.

`SPEC` mirrors the upstream `wssri-intermediate.dat` gameplay data; `BLEND` is
...
recolour".  Run from the repo root:
    ...
    python3 -m ways.wooden_sleeper_steel_rail_improved_intermediate
"""
