...
# Five compartments (but compartment capacity as a third)
_BLEND = 'trains/Carriages/lbscr-4wheel-20ft-brake-composite.blend'
_UPSTREAM_DAT = 'trains/lbscr-4wheel-second.dat'

SPECS = [
    Vehicle(
        name='LBSCR-4Wheel-Second',
        waytype='track',
        copyright='Kieron',
        freight='Passagiere',
        intro_year=1872,
        ...
        upgrade=['LBSCR-4Wheel-Second-fitted'],
        blend=_BLEND,
        upstream_dat=_UPSTREAM_DAT,
    ),
    Vehicle(
        name='LBSCR-4Wheel-Second-fitted',
        waytype='track',
