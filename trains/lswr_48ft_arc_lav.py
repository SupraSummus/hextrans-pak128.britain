...
# Lavatory compartment carriages with arc roofs
# This is a centre brake tricomposite
# See Jenkinson p. 160
_BLEND = 'trains/Carriages/lswr-48ft.blend'
_UPSTREAM_DAT = 'trains/lswr-48ft-arc-lav.dat'

SPECS = [
    Vehicle(
        name='lswr-48ft-arc-lav-brake',
        waytype='track',
    ...
    Vehicle(
        ...
        comfort_by_class=[0, 87, 89, 93],
        liverytype=['LSWR-pea-green', 'LSWR-sage', 'SR-Olive-Green', 'SR-Malachite-Green'],
        blend=_BLEND,
        upstream_dat=_UPSTREAM_DAT,
    ),
    Vehicle(
        name='lswr-48ft-arc-lav-composite',
        waytype='track',
        copyright='JamesPetts',
        freight='Passagiere',
        intro_year=1889,
