...
_UPSTREAM_DAT = 'trains/lner-gresley-express-coach-all-doors.dat'

SPECS = [
    Vehicle(
        name='LNER-Gresley-Express-Coach-All-Doors',
        waytype='track',
    ...
    Vehicle(
        name='LNER-Gresley-Express-Coach-All-Doors-first',
        waytype='track',
        copyright='Kieron/jamespetts',
        freight='Passagiere',
        intro_year=1923,
