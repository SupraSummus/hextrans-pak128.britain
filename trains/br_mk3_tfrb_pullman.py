...
_UPSTREAM_DAT = 'trains/br-mk3-tfrb-pullman.dat'

SPECS = [
    Vehicle(
        name='BR-Mk3-TRFB-pullman',
        waytype='track',
    ...
    Vehicle(
        ...
        payload_by_class=[0, 0, 0, 18],
        comfort_by_class=[0, 150, 0, 173],
        liverytype=['BR-Blue', 'IC-Executive', 'GWT', 'FGW-Green', 'Firstgroup-Mauve', 'Firstgroup-Neon', 'GNER', 'National-Express', 'GC-Original', 'GC-Daylight', 'Chiltern-Mainline', 'Virgin-original'],
        blend=_BLEND,
        upstream_dat=_UPSTREAM_DAT,
    ),
]
