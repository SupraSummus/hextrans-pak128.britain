...
# D321: see Jenkinson (LNWR) p. 106
# See also ibid p. 172
_BLEND = 'trains/Carriages/lnwr-57ft-non-cor.blend'
_UPSTREAM_DAT = 'trains/lnwr-57ft-non-cor-lav.dat'

SPECS = [
    Vehicle(
        name='LNWR-57ft-non-cor-lav-brake-front',
        waytype='track',
        ...
        comfort_by_class=[0, 102, 103, 143],
        liverytype=['LNWR-Black', 'LMS-Standard', 'BR-Early'],
        blend=_BLEND,
        upstream_dat=_UPSTREAM_DAT,
    ),
    Vehicle(
        name='LNWR-57ft-non-cor-lav-brake-rear',
        waytype='track',
        copyright='jamespetts',
        freight='Passagiere',
        intro_year=1907,
    ...
    Vehicle(
        ...
        payload_by_class=[0, 30, 0, 21],
        comfort_by_class=[0, 95, 95, 143],
        liverytype=['LNWR-Black', 'LMS-Standard', 'BR-Early'],
        blend=_BLEND,
        upstream_dat=_UPSTREAM_DAT,
    ),
