...
# Stroudley Suburban Carriages
# See http://basilicafields.wordpress.com/2010/12/19/lbscr-carriages
# The fitted vehicles use the Westinghouse air brake
# They therefore have better brake force than contemporaries,
# but are more expensive.
_BLEND = 'trains/Carriages/lbscr-4wheel-20ft-brake-composite.blend'
_UPSTREAM_DAT = 'trains/lbscr-4wheel-brake.dat'

SPECS = [
    Vehicle(
        name='LBSCR-4Wheel-Brake-front',
        waytype='track',
        ...
        upgrade=['LBSCR-4Wheel-Brake-front-fitted'],
        blend=_BLEND,
        upstream_dat=_UPSTREAM_DAT,
    ),
    Vehicle(
        name='LBSCR-4Wheel-Brake-rear',
        waytype='track',
        copyright='Kieron/James/JamesPetts',
        freight='Passagiere',
        intro_year=1872,
        ...
        comfort_by_class=[0, 62],
        liverytype=['LBSCR-Stroudley', 'LBSCR-Marsh', 'LBSCR-Late', 'SR-Olive-Green'],
        upgrade=['LBSCR-4Wheel-Brake-rear-fitted'],
        blend=_BLEND,
        upstream_dat=_UPSTREAM_DAT,
    ),
    Vehicle(
        name='LBSCR-4Wheel-Brake-front-fitted',
        waytype='track',
        copyright='Kieron/James/JamesPetts',
        freight='Passagiere',
        intro_year=1875,
    ...
    Vehicle(
        name='LBSCR-4Wheel-Brake-rear-fitted',
        waytype='track',
        copyright='Kieron/James/JamesPetts',
        freight='Passagiere',
        intro_year=1875,
