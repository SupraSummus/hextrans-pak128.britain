...
# See Lacy & Dow vol. 2 pp. 453-4
# Anglo-Scottish stock
#
# This is a third class diner. Do we need
# a first class diner (D1196, p. 456)?
#
SPEC = Vehicle(
    name='MR-65ft-clerestory-dining-d575',
    waytype='track',
    ...
    payload_by_class=[0, 27],
    comfort_by_class=[0, 145],
    liverytype=['MR-Standard'],
    blend='trains/Carriages/mr-65ft-clerestory.blend',
    upstream_dat='trains/mr-65ft-clerestory-dining.dat',
)
