...
_BLEND = 'trains/Carriages/lswr-56ft-sub-br-emu.blend'
_UPSTREAM_DAT = 'trains/lswr-56ft-lav.dat'

SPECS = [
    Vehicle(
        name='lswr-56ft-lav-brake-front',
        waytype='track',
    ...
    Vehicle(
        name='lswr-56ft-lav-composite-1st-3rd',
        waytype='track',
        copyright='JamesPetts',
        freight='Passagiere',
        intro_year=1904,
