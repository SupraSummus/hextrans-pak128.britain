...
_BLEND = 'trains/Carriages/br-mk3-trb-chiltern.blend'
_UPSTREAM_DAT = 'trains/br-mk3-trb.dat'
...
SPECS = [
    ...
    Vehicle(
        ...
        payload_by_class=[0, 0, 0, 24],
        comfort_by_class=[0, 150, 0, 173],
        liverytype=['BR-Blue', 'IC-Executive', 'GWT', 'FGW-Green', 'Firstgroup-Mauve', 'Firstgroup-Neon', 'GNER', 'National-Express', 'GC-Original', 'GC-Daylight', 'Chiltern-Mainline', 'Virgin-original', 'Anglia-original', 'One', 'NXEA', 'Abellio-Greater-Anglia'],
        blend=_BLEND,
        upstream_dat=_UPSTREAM_DAT,
    ),
]
