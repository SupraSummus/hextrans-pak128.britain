...
_UPSTREAM_DAT = 'trains/lner-gresley-express-brake.dat'

SPECS = [
    Vehicle(
        name='LNER-Gresley-Express-Brake-front',
        waytype='track',
        copyright='Kieron',
        freight='Passagiere',
        intro_year=1932,
    ...
    Vehicle(
        name='LNER-Gresley-Express-Brake-rear',
        waytype='track',
        copyright='Kieron',
        freight='Passagiere',
        intro_year=1932,
