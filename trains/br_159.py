...
# https://en.wikipedia.org/wiki/British_Rail_Class_159
_BLEND = 'trains/Railcars/br-159-a-nse.blend'
_UPSTREAM_DAT = 'trains/br-159.dat'
...
SPECS = [
    Vehicle(
        ...
        constraint_next=['br-159-rear', 'br-159-centre'],
        payload_by_class=[0, 32, 0, 23],
        comfort_by_class=[0, 118, 118, 135],
    ...
    Vehicle(
        ...
        smoke='Diesel-light',
        constraint_prev=['br-159-front'],
        constraint_next=['br-159-rear'],
    ...
    Vehicle(
        ...
        can_lead_from_rear=1,
        smoke='Diesel-light',
        constraint_prev=['br-159-centre', 'br-159-front'],
