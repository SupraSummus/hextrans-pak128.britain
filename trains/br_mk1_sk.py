...
# This is the Eastern/Midland region version with
# three aside in the compartments and arm rests.
SPEC = Vehicle(
    name='BR-Mk1-SK',
    waytype='track',
    ...
    blend='trains/Carriages/br-mk1-sk-jaffa.blend',
    upstream_dat='trains/br-mk1-sk.dat',
)
