...
SPEC = Vehicle(
    ...
    payload_by_class=[0, 64],
    comfort_by_class=[0, 137],
    liverytype=['BR-Early', 'BR-Revised', 'BR-Blue', 'IC-Executive', 'NSE-Standard', 'Regional-Railways-Standard'],
    upgrade=['BR-430[REP]Middle', 'BR-491[TC]Middle'],
    blend='trains/Carriages/br-mk1-bc-cc.blend',
    upstream_dat='trains/br-mk1-tso.dat',
)
