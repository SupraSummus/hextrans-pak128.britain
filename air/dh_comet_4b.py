...
_BLEND = 'air/dh-comet-4b.blend'
_UPSTREAM_DAT = 'air/dh-comet-4b.dat'
...
Vehicle(
    ...
    payload_by_class=[0, 0, 47, 0, 24],
    comfort_by_class=[0, 0, 124, 0, 151],
    upgrade=['dh-comet-4b-high-density'],
    blend=_BLEND,
    upstream_dat=_UPSTREAM_DAT,
),
Vehicle(
    name='dh-comet-4b-high-density',
    waytype='air',
    copyright='Emmanuel Baranger',
    freight='Passagiere',
    engine_type='turbine',
